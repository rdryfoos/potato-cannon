...
import { Square, CheckSquare, Loader2, XCircle, MessageSquare } from 'lucide-react'
  ...
  return (
    <>
      <div className="border-t border-border shrink-0">
        {/* The header. It is a label, not a control: the tasks are always shown. */}
        <div
          className="flex items-center gap-2 w-full px-4 py-2 text-xs font-medium text-text-secondary"
        ...
        <div
          ...
          className="overflow-y-auto max-h-[200px] px-3 pb-3"
        >
